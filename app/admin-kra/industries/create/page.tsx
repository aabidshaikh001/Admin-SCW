...
export default function CreateFeaturePage() {
  ...
  try {
    ...
    const response = await fetch("https://api.smartcorpweb.com/api/industry", {
      method: "POST",
      body: fd,
    })
    ...
    if (response.ok) {
      ...
      throw new Error("Failed to create Industries")
    }
  } catch (error) {
    console.error("Error creating Industries:", error)
    toast({
      title: "Error",
      description: "Failed to create Industries",
      variant: "destructive",
    })
  } finally {
    setLoading(false)
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground">Create Industries</h1>
            <p className="text-muted-foreground">Create the KRA Industries details and styling</p>
          </div>
        </div>
