...
export default function CreateFeaturePage() {
  ...
  try {
    ...
    const response = await fetch("https://api.smartcorpweb.com/api/client", {
      method: "POST",
      body: fd,
    })
    ...
    toast({
      title: "Error",
      description: "Failed to create Clients",
      variant: "destructive",
    })
  } finally {
    setLoading(false)
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground">Add Clients</h1>
            <p className="text-muted-foreground">Add the KRA Clients details and styling</p>
          </div>
        </div>
