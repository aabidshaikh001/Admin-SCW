        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
          <form onSubmit={handleSubmit}>
            <Tabs defaultValue="basic" className="space-y-6">
              ...
              {/* Other tabs content similar to add page but with existing values */}
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="adminPwd">Admin Password (Leave blank to keep current)</Label>
                        <Input
                          id="adminPwd"
                          type="password"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="webAdminPwd">Web Admin Password (Leave blank to keep current)</Label>
                        <Input
                          id="webAdminPwd"
                          type="password"
